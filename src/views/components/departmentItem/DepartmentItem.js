...
import { useDeleteDepartmentMutation } from "../../../redux/services/deapartmentService";
    ...
    <div className="flex gap-5 border p-5">
      ...
      <div>
        ...
        <div className="mt-2 flex gap-2 items-center">
          ...
          <button
            onClick={() => deleteDepartmentFunc(department._id)}
            class="inline-flex items-center py-1 px-3 text-sm font-medium text-center text-white rounded-lg bg-red-600 hover:bg-red-700 focus:ring-4 focus:outline-none focus:ring-blue-300"
          >
            {deleteLoading ? (
              <>
                Deleting
